...
import { FitScoreBreakdown, OpportunityAnalysis } from '../../types';
import { TrendingUp, CheckCircle2, AlertTriangle, ShieldCheck, Sparkles, ArrowRight, Award, Zap } from 'lucide-react';
...
export const BidDecisionView: React.FC<Props> = ({ analysis, onProceedToProposal }) => {
  ...
  const components = [
    ...
    },
    {
      ...
      weight: '15%',
      score: fit.pastPerformanceScore,
      max: 100,
    ...
    },
    {
      ...
      weight: '15%',
      score: fit.deliveryFeasibilityScore,
      max: 100,
      description: 'Available team capacity and 45-day transition timeline feasibility.'
    }
  ];
      ...
      <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          ...
          <div className="flex items-baseline gap-3 my-2">
            <span className="text-5xl font-extrabold text-white">{fit.overallFitScore}</span>
        ...
        <div className="text-center md:text-right shrink-0">
          <div className={`px-4 py-2 rounded-xl font-black text-sm uppercase tracking-wider ${
            ...
            {analysis.bidRecommendation} RECOMMENDATION
          </div>
        </div>
      </div>
